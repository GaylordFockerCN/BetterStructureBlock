...
public class ModItemTabs {
	...
	public static final RegistryObject<CreativeModeTab> MODE_TAB = REGISTRY.register(BetterBlockStructureMod.MOD_ID,
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.better_structure_block."+ BetterBlockStructureMod.MOD_ID)).icon(() -> new ItemStack(ModBlocks.BETTER_STRUCTURE_BLOCK.get())).displayItems((parameters, tabData) -> {
				tabData.accept(ModBlocks.BETTER_STRUCTURE_BLOCK.get());
			}).build());
}
